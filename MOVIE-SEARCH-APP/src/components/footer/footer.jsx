...
function Footer(){
    return <div className="bg-cyan-700 text-white flex mt-15 justify-between items-center flex-wrap py-10 px-6 items-start gap-10 ">
        ...
        <div className="w-120">
            ...
            <div className=" mt-3 flex flex-wrap gap-4">
                <input className="border-3 capitalize p-2 rounded-4xl text-2xl border-red-600 w-60" type="text"placeholder="enter-email"/>
        ...
        <div className="flex flex-col" id="c">
            ...
            <p className="flex items-center gap-2 text-2xl flex-wrap" >
                <MdEmail className="text-2xl text-yellow-600"/>:abdullah##@gmail.com
                </p>
